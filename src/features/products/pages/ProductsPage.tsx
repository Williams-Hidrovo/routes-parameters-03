...
export const ProductsPage = () => {
  ...
  const listaFiltrada=productosData.filter(p => p.categoria==filtroActivo);
  const showLista=filtroActivo==ICategorias.Todos || filtroActivo==null ? productosData : listaFiltrada
